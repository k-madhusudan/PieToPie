...
public class GoalsListActivityArchived extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goals_list_archived);
        final DBHandler dbHandler = new DBHandler(getApplicationContext());
        Cursor c = dbHandler.getArchivedGoals();
        ...
        getListView().setOnItemLongClickListener(new OnItemLongClickListener() {
            public boolean onItemLongClick(AdapterView<?> adapterView, View arg1, int arg2, long arg3) {
                Toast.makeText(GoalsListActivityArchived.this.getApplicationContext(), "Deleting", Toast.LENGTH_LONG).show();
                dbHandler.deleteCurrentGoal(arg3);
                adapter2.swapCursor(dbHandler.getArchivedGoals());
                return true;
            }
        });
    }
